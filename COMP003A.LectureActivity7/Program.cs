...
namespace COMP003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] array2 = new int[] { 1, 3, 5, 7, 9 }; // declares a single-dimensionalarray element with values
             ...
             * They are stored in sequential blocks of memory, making it extremely fast access them.
             * Also, you will get a runtime error of OutOfBoundsException 
             * when accessing an index that does not exist
             */
            Console.WriteLine("array 2 Traversal");
        ...
        /// </summary>
        /// <param name="array">Integer array inpuit</param>
        /// <returns></returns>
        ...
        {
            // ou can use a foreach-loop or other looping statements for list traversals
